...
d_all %>% 
  ...
  gtsave(filename = paste0(output_dir, "/vaccination_history_by_age_table.html"))

# Include html table
htmltools::includeHTML(fs::path(output_dir, "/vaccination_history_by_age_table.html"))
```
...
tab = subgroup_gt(d_75plus) %>%
 gtsave(filename = paste0(output_dir, "/vaccination_history_by_demographic_clinical_75plus_table.html"))
  
# Include html table
htmltools::includeHTML(fs::path(output_dir, "/vaccination_history_by_demographic_clinical_75plus_table.html"))
```
...
subgroup_gt(d_65to74) %>%
 gtsave(filename = paste0(output_dir, "/vaccination_history_by_demographic_clinical_65to74_table.html"))
htmltools::includeHTML(fs::path(output_dir, "/vaccination_history_by_demographic_clinical_65to74_table.html"))
```
...
subgroup_gt(d_50to64) %>%
 gtsave(filename = paste0(output_dir, "/vaccination_history_by_demographic_clinical_50to64_table.html"))
htmltools::includeHTML(fs::path(output_dir, "/vaccination_history_by_demographic_clinical_50to64_table.html"))
```
...
subgroup_gt(d_18to49) %>%
 gtsave(filename = paste0(output_dir, "/vaccination_history_by_demographic_clinical_18to49_table.html"))
htmltools::includeHTML(fs::path(output_dir, "/vaccination_history_by_demographic_clinical_18to49_table.html"))
```
