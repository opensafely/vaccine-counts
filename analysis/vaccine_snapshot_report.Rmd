...
<a href="#uk-vaccine-implementation">UK vaccine implementation in adults</a>
</ul>
...
<button class="btn btn-primary" data-toggle="collapse" data-target="#table_75plus"> Show/hide table</button>  

<div id="table_75plus" class="collapse">
...
<button class="btn btn-primary" data-toggle="collapse" data-target="#table_65to74"> Show/hide table</button>  

<div id="table_65to74" class="collapse">
...
<button class="btn btn-primary" data-toggle="collapse" data-target="#table_50to64"> Show/hide table</button>  

<div id="table_50to64" class="collapse">
...
<button class="btn btn-primary" data-toggle="collapse" data-target="#table_18to49"> Show/hide table</button>  

<div id="table_18to49" class="collapse">
