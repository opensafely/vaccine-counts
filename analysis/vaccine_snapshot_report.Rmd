...
d <- read_rds(here::here("output", "snapshot_report", "snapshot_summary.rds")) %>%
  mutate(Clean_N = formatC(N, big.mark=",", format="f"),
         Clean_0 = formatC(Dose_0, big.mark=",", format="f"),
         Clean_1 = formatC(Dose_1, big.mark=",", format="f"),
         Clean_2 = formatC(Dose_2, big.mark=",", format="f"),
         Clean_3 = formatC(Dose_3, big.mark=",", format="f"),
         Clean_4 = formatC(Dose_4, big.mark=",", format="f"),
         Clean_5plus = formatC(Dose_5plus, big.mark=",", format="f"),
         Clean_past_12m = formatC(Vax_past_12m, big.mark=",", format="f"),
         Clean_past_24m = formatC(Vax_past_24m, big.mark=",", format="f"),
...
-   This report summarises the vaccination history of adults in England as of 01 September 2023 - immediately prior to the Autumn 2023 COVID vaccine booster campaign.
...
-   Unvaccinated individuals were assigned a value of 36 months for time since last dose (exceeding the maximum observation among vaccinated individuals).

-   Patient counts are rounded to the nearest 7. Rounded counts of <=7 are redacted, as are all summary metrics for population subgroups with less than 100 individuals.
